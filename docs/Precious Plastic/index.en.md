...
## Why recycle PLA?
PLA (Polylactic Acid) is industrially biodegradable, but in everyday life, it often ends up in landfills. By recycling it locally in our FabLab, we learn about:
* **Circular Economy:** How to close the loop.
* **Material Science:** How plastic changes character when heated.
* **Design with Constraints:** How to create beautiful objects from the flakes we have available.
...
!!! info "Get Started"
    Ready to make your own recycled sheet? Start by reading our [safety instructions](./sikkerhed.en.md) before turning on the machines!
